(function ($) {
    ...
    $(document).ready(function () {
      ...
      function updateActiveSection() {
        ...
        var isBottomReached = (scrollDistance + windowHeight) >= $(document).height();
        ...
        $('.section').each(function () {
          ...
          if (
            (scrollDistance >= sectionTop - windowHeight / 2 && scrollDistance < sectionTop + sectionHeight - windowHeight / 2) ||
  ...
  $('.refresh-link').click(function(e) {
    ...
    $('#portfolio-flters li').on('click', function () {
     ...
     // Portfolio isotope and filter
     var portfolio1Isotope = $('.portfolio1-container').isotope({
        itemSelector: '.portfolio1-item',
        layoutMode: 'fitRows'
    });
    $('#portfolio1-flters li').on('click', function () {
        $("#portfolio1-flters li").removeClass('active');
        $(this).addClass('active');

        portfolio1Isotope.isotope({filter: $(this).data('filter')});
    });
